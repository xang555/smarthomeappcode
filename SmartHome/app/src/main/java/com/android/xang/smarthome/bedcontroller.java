...
/**
 * Created by xang- on 27/10/2015.
 */
public class bedcontroller extends AppCompatActivity {

    private String[] list={"ຫ້ອງນອນເບີ 1","ຫ້ອງນອນເບີ 2","ຫ້ອງນອນເບີ 3"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onrestore();
        for (int i=0;i<SmartHome_interface.PINBEDARRAY.length;i++){
            onsendcommand(SmartHome_interface.PINBEDARRAY[i]);
            reqsocket(SmartHome_interface.PINBEDARRAY[i]);
        }
    ...
    public class adapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            View v= LayoutInflater.from(bedcontroller.this).inflate(R.layout.item_listview,parent,false);
            ...
            aSwitch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (aSwitch.isChecked()){
                        sendcommand(SmartHome_interface.COMMANDON,SmartHome_interface.PINBEDARRAY[position]);
                    }else{
                        sendcommand(SmartHome_interface.COMMANDOFF,SmartHome_interface.PINBEDARRAY[position]);
                    }
            ...
            try{
                ...
                Toast.makeText(bedcontroller.this,"ກະລຸນາລອງໄຫມ",Toast.LENGTH_SHORT).show();
            }
            ...
            public void call(Object... args) {
                ...
                try {
                    ...
                    if(object.getString(SmartHome_interface.COMMAND).equals(SmartHome_interface.COMMANDON) && object.getInt(SmartHome_interface.PIN)==Pincontrol){
                        ...
                        bedcontroller.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(bedcontroller.this,username+"ເປີດໄຟ",Toast.LENGTH_SHORT).show();
                            }
                        });
                        ...
                        bedcontroller.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(bedcontroller.this,username+"ປິດໄຟ",Toast.LENGTH_SHORT).show();
