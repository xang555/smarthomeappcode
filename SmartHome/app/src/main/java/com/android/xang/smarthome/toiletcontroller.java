...
public class toiletcontroller extends AppCompatActivity {

    private String[] list={"ຫ້ອງນໍ້າເບີ 1","ຫ້ອງນໍ້າເບີ 2","ຫ້ອງນໍ້າເບີ 3","ຫ້ອງນໍ້າເບີ 4"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onrestore();
        for (int i=0;i<SmartHome_interface.PINTOILET.length;i++){
            onsendcommand(SmartHome_interface.PINTOILET[i]);
            reqsocket(SmartHome_interface.PINTOILET[i]);
        }
    ...
    public class adapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            View v= LayoutInflater.from(toiletcontroller.this).inflate(R.layout.item_listview,parent,false);
            ...
            aSwitch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (aSwitch.isChecked()){
                        sendcommand(SmartHome_interface.COMMANDON,SmartHome_interface.PINTOILET[position]);
                    }else{
                        sendcommand(SmartHome_interface.COMMANDOFF,SmartHome_interface.PINTOILET[position]);
                    }
            ...
            try{
                ...
                Toast.makeText(toiletcontroller.this,"ກະລຸນາລອງໄຫມ",Toast.LENGTH_SHORT).show();
            }
            ...
            public void call(Object... args) {
                ...
                try {
                    ...
                    if(object.getString(SmartHome_interface.COMMAND).equals(SmartHome_interface.COMMANDON) && object.getInt(SmartHome_interface.PIN)==Pincontrol){
                        ...
                        toiletcontroller.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(toiletcontroller.this, username + "ເປີດໄຟ", Toast.LENGTH_SHORT).show();
                            }
                        });
                        ...
                        toiletcontroller.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(toiletcontroller.this,username+"ປິດໄຟ",Toast.LENGTH_SHORT).show();
